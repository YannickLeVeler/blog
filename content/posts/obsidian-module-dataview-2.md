...
## Gestion des sources
Les requêtes <a target="_blank" rel="noopener noreferrer" href="https://github.com/blacksmithgu/obsidian-dataview"> **Dataview**</a> peuvent être réalisés sur quatre types de sources en utilisant le mot clé **FROM** : les dossiers, les fichiers, les liens et les tags.
