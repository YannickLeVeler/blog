...
<a target="_blank" rel="noopener noreferrer" href="https://espanso.org/">Espanso</a> de <a target="_blank" rel="noopener noreferrer" href="https://federicoterzi.com/">Frederico Terzi</a> est un Text Expander, c'est à dire, un outil qui va vous permettre de configurer des raccourcis clavier afin d'insérer rapidement des phrases, des mots ou des blocs de texte.

<a target="_blank" rel="noopener noreferrer" href="https://espanso.org/">Espanso</a> est un outil gratuit, open-source, supporté par Windows, Linux et macOS et basé sur des fichiers plats au format <a target="_blank" rel="noopener noreferrer" href="https://fr.wikipedia.org/wiki/YAML">YAML</a>.
...
Ce fichier va vous permettre de configurer <a target="_blank" rel="noopener noreferrer" href="https://espanso.org/">espanso</a> notamment afin désactiver <a target="_blank" rel="noopener noreferrer" href="https://espanso.org/">espanso</a> quand vous utilisez certaines applications ou définir une touche pour activer ou désactiver <a target="_blank" rel="noopener noreferrer" href="https://espanso.org/">espanso</a>.

La seule modification que j'ai réalisée sur ce fichier consiste à activer l'auto restart afin qu'<a target="_blank" rel="noopener noreferrer" href="https://espanso.org/">espanso</a> se recharge dès qu'un fichier est modifié. 
...
Pour voir toutes les correspondances rendues possibles par <a target="_blank" rel="noopener noreferrer" href="https://espanso.org/">Espanso</a>, vous pouvez utiliser le lien suivant : https://espanso.org/docs/matches/basics/#
### Basic
...
Par moment, je vais avoir besoin d'une mise en former plus poussée. <a target="_blank" rel="noopener noreferrer" href="https://espanso.org/">Espanso</a> nous permet d'utiliser le format <a target="_blank" rel="noopener noreferrer" href="https://en.wikipedia.org/wiki/Markdown">Markdown</a> ou le format <a target="_blank" rel="noopener noreferrer" href="https://en.wikipedia.org/wiki/HTML">HTML</a>.

Pour l'exemple ci dessous, j'ai choisi l'option <a target="_blank" rel="noopener noreferrer" href="https://en.wikipedia.org/wiki/HTML">HTML</a>.
...
Lorsque vous définissez deux résultats pour un même raccourci, <a target="_blank" rel="noopener noreferrer" href="https://espanso.org/">espanso</a> vous proposera une pop-up afin de choisir quel résultat vous voulez appliquer.
...
Pour connaitre toutes les extensions disponibles dans <a target="_blank" rel="noopener noreferrer" href="https://espanso.org/">Espanso</a>, vous pouvez utiliser le lien suivant : https://espanso.org/docs/matches/extensions/#date-extension
...
L'extrait <a target="_blank" rel="noopener noreferrer" href="https://fr.wikipedia.org/wiki/YAML">YAML</a> correspondant au formulaire : 
...
Souhaitant pouvoir utiliser ma configuration espanso sur plusieurs ordinateurs, je vous propose d'utiliser <a target="_blank" rel="noopener noreferrer" href="https://git-scm.com/">Git</a> et <a target="_blank" rel="noopener noreferrer" href="https://github.com/">Github</a>. 
...
```git push``` afin de mettre à jour le repository sur <a target="_blank" rel="noopener noreferrer" href="https://github.com/">Github</a>
