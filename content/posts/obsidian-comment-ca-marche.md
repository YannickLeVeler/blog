...
J'ai un deuxième **coffre** uniquement pour la formation à <a target="_blank" rel="noopener noreferrer" href="https://obsidian.md/"> **Obsidian**</a> . Je l'utilise pour expliquer l'utilisation d'<a target="_blank" rel="noopener noreferrer" href="https://obsidian.md/"> **Obsidian**</a>  et de ces plugins.

A force de lecture sur le sujet, je sais que d'autres utilisateurs d'<a target="_blank" rel="noopener noreferrer" href="https://obsidian.md/"> **Obsidian**</a>  peuvent créer un coffre pour un projet particulier (l'écriture d'un livre, la construction d'une maison). Je comprends leur choix mais ce n'est pas mon mode de fonctionnement, j'ai besoin de pouvoir connecter mes notes entre elles.
